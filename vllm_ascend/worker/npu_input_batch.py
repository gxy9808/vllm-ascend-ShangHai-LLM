...
class NPUInputBatch(InputBatch):
    ...
    def __init__(
        ...
        # v0.27.x forks (e.g. vllm-step4) added valid_vocab_size to InputBatch
        # for padded-vocab models; mirror the upstream defaulting semantics.
        self.valid_vocab_size = vocab_size if valid_vocab_size is None else valid_vocab_size
